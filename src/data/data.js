...
const experience = [
		...
		projects: [
			{
				...
				description: [
					'Developed front-end for photos and checkout microservices and integrated with other services via a proxy server utilizing REST APIs to share data across services.',
			...
			},
			{
				...
				description: [
					...
					'Configured a Redis cache to use an LFU cache eviction policy for faster read operations that averaged less than 50ms.',
					...
					'Dockerized and deployed database, server, and proxy containers into a cluster of AWS EC2 instances.'
				]
			}
		]
	},
	{
		...
		description: [
			'Communicate directly with the client to ensure satisfaction during the rollout of the new Vendor Drug Program project.',
			'Perform end-to-end testing for newly released platform (PEMS) to identify bugs across the stack and enforce contract requirements.',
